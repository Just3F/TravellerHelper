            ...
            $("#m_login_signin_submit").click(function (e) {
                ...
                t.validate({
                    ...
                    success: function (e, r, n, l) {
                        console.log(n)
                        if (n.responseJSON.HasError == true) {
                            setTimeout(function () {
                                a.removeClass("m-loader m-loader--right m-loader--light").attr("disabled", !1), i(t, "danger", n.responseJSON.Error + " Please try again.")
                            }, 1500)
                        } else {
                            window.location.href = n.responseJSON
                        }
                    }
                }))
            })
